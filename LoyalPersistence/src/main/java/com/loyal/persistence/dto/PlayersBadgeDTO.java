...
public class PlayersBadgeDTO  implements java.io.Serializable {
    ...
    /** full constructor */
    public PlayersBadgeDTO(Integer playerId, Integer badgeId, String createdBy, Date createdTimestamp, String updatedBy, Date updatedTimestamp) {
        this.playerId = playerId;
        this.badgeId = badgeId;
